...
export default function CreatePropertyPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    console.log("🚀 [SUBMIT] Iniciando creación de propiedad");
    ...
    console.log("📋 [PAYLOAD] Datos de la propiedad:", spanishPayload);
    ...
    try {
      if (images && images.length > 0) {
        ...
        console.log("✅ [SUCCESS] Propiedad sin imágenes creada exitosamente");
      }
      setLoading(false);
      // notify success
      try {
